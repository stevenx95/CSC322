...
public class ComplaintText {
    ...
    public ComplaintText(IntegerProperty complaintId, IntegerProperty docID, IntegerProperty version, StringProperty owner, StringProperty complainer, StringProperty message) {
